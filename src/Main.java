...
public class Main {
    public static void main(String[] args) {
        Manager manager = new Manager(new HashMap<Integer, DeepTask>(), 1);
        ...
        manager.update(task1.id,Task.makeStandardTask(null,"хлеб, колбаса, сыр и молоко",Status.IN_PROGRESS));
    }
}
